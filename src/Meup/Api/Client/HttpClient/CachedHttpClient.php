...
use HomeApi\Client\HttpClient\Cache\CacheInterface;
use HomeApi\Client\HttpClient\Cache\FilesystemCache;

/**
 * Performs requests on florianajir API using If-Modified-Since headers.
    ...
    public function getCache()
    {
        if (null === $this->cache) {
            $cacheDir = $this->options['cache_dir'] ?
                : sys_get_temp_dir().DIRECTORY_SEPARATOR.'home-api-cache';
